 ...
 *
 * @param {Object} obj1 Premier objet à comparer
 * @param {Object} obj2 Second objet à comparer
 * @param {Object} returnValue de retour si il n'y a aucune différence, par défaut = {}
 *
...
export function deepCompare(obj1, obj2, returnValue = {}) {
  ...
  if (obj1 && obj2) {
    ...
    keys1.forEach((key) => {
      // parcours du première objet
      if (typeof obj2[key] === "undefined") {
        // si le champ existe ou pas dans le deuxième objet
        rels[key] = obj1[key];
        empty = false;
      } else if (obj1[key] !== obj2[key]) {
        if (typeof obj1[key] === "object" && typeof obj2[key] === "object") {
          // si les deux sont des objets alors les compare
    ...
    keys2.forEach((key) => {
      // On vérifie qu'il n'y a pas de champ supplémentaire dans le second objet
